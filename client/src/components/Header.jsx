...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >Unlesah your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen</motion.p>
            ...
            <motion.p
                ...
                className='mt-2 text-neutral-600'>Generate iamges from imagify</motion.p>
        </motion.div>
    )
}
